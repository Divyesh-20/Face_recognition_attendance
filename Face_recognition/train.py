...
class Train:
    def __init__(self,root): 
        ...
        #button
        b1_1=Button(self.root,text="Train Data",command=self.train_classifier,cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="black")
        b1_1.place(x=0,y=380,width=1530,height=60)

        img_bottom=Image.open(r"college_images\ai.jpg")
