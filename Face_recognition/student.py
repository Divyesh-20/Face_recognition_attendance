...
class student:
    def __init__(self,root): 
       ...
       # Gender_entry.grid(row=2,column=1,padx=10,pady=5,sticky="W")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=31,font=("times new roman",11,"bold"),bg="blue",fg="white")
...
#*******************delete function**********************#
    def delete_data(self):
        if self.var_std_id.get()=="":
            messagebox.showerror("student Id requied",parent=self.root)
        else:
            try:
        ...
        try:
            ...
            # Load the face classifier
                ...
                if face_classifier.empty():
                    raise Exception("Failed to load face classifier XML file.")
            ...
            print(f"Error: {es}")  # Print error message to console
            messagebox.showerror("Error", f"Due To: {str(es)}", parent=self.root)
